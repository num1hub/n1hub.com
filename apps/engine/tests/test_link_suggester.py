...
def test_link_suggester_suggests_links():
...
def test_link_suggester_confidence_bounds():
...
def test_link_suggester_determines_duplicates():
...
def test_link_suggester_filters_by_relation_types():
