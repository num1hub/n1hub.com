...
>({
  ...
  const payloadItems = payload as
    | ReadonlyArray<TooltipPayload<TValue, TName>>
    | undefined

  const tooltipLabel = React.useMemo(() => {
    if (hideLabel || !payloadItems || payloadItems.length === 0) {
      return null
    }
  ...
  if (!active || !payloadItems || payloadItems.length === 0) {
    return null
  }
