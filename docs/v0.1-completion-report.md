...
- `__tests__/e2e/upload-flow.test.tsx` - Frontend upload tests
- `__tests__/e2e/rag-scope-toggle.test.tsx` - Frontend scope tests
- `__tests__/e2e/chat-panel.test.tsx` - Frontend chat tests
...
- `lib/state.ts` - Extended with scope types
