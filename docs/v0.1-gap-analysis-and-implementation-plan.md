...
**File**: `app/api/**/*.ts`, `apps/engine/app/main.py`
...
**Files to modify**:
- `components/rag-scope-toggle.tsx` - Add scope type selector
- `lib/state.ts` - Update RagScopeState to include scope type
- `lib/api.ts` - Update runChat to send scope type
